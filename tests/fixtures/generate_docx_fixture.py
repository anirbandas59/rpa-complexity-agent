...
def generate_process_docx():
    ...
    h1 = doc.add_heading("Process Overview", level=1)
    ...
    h1 = doc.add_heading("Target Applications", level=1)
    ...
    h1 = doc.add_heading("Process Steps", level=1)

    h2 = doc.add_heading("Step 1 - Login to SAP", level=2)
    doc.add_paragraph(
    ...
    h2 = doc.add_heading("Step 2 - Navigate to Transaction", level=2)
    doc.add_paragraph(
    ...
    h2 = doc.add_heading("Step 3 - Extract Data", level=2)
    doc.add_paragraph(
    ...
    h2 = doc.add_heading("Step 4 - Save to Excel", level=2)
    doc.add_paragraph(
    ...
    h1 = doc.add_heading("Business Rules", level=1)
    ...
    h1 = doc.add_heading("Digital Layouts", level=1)
    doc.add_paragraph(
    ...
    # Add a table
    h1 = doc.add_heading("Process Mapping", level=1)
    ...
    h1 = doc.add_heading("Exception Handling", level=1)
    doc.add_paragraph(
